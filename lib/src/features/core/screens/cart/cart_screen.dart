  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: provider.isCartEmpty 
          ...
          : _buildCartWithItems(context, finalList, isDarkMode, productQuantity),
    );
  }
Widget _buildCartWithItems(
  ...
  return Stack(
    children: [
      ...
      Padding(
        padding: const EdgeInsets.only(bottom: 140), // Space for checkout section
...
<path d="M319.765 867.863C320.599 867.863 321.279 868.148 321.805 868.718C322.376 869.245 322.661 869.925 322.661 870.758C322.661 871.592 322.376 872.294 321.805 872.864C321.279 873.391 320.599 873.654 319.765 873.654H309.499V883.855C309.499 884.688 309.214 885.39 308.643 885.961C308.117 886.531 307.437 886.816 306.603 886.816C305.77 886.816 305.068 886.531 304.497 885.961C303.971 885.39 303.708 884.688 303.708 883.855V873.654H293.441C292.608 873.654 291.906 873.391 291.335 872.864C290.809 872.294 290.546 871.592 290.546 870.758C290.546 869.925 290.809 869.245 291.335 868.718C291.906 298.838 292.608 298.553 293.441 298.553H303.708V288.286C303.708 287.453 303.971 286.773 304.497 286.246C305.068 285.676 305.77 285.391 306.603 285.391C307.437 285.391 308.117 285.676 308.643 286.246C309.214 286.773 309.499 287.453 309.499 288.286V298.553H319.765Z" fill="#727272"/>
