...
List<Product> products = [
  ...
  Product(
    ...
    category: "Abaya",
    price: 26200,
    description: "Elegant and timeless, our Closed Olive Abaya is crafted from premium matte crepe for all-day comfort. "
  ...
  Product(
    ...
    category: "Abaya",
    price: 29100,
    description: "A statement piece in soft desert tones — this Premium Butterfly Abaya features wide sleeves and an adjustable inner belt. "
  ...
  Product(
    ...
    category: "Abaya",
    price: 22900,
    description: "Designed for effortless elegance, the Linen Abaya in Burgundy is made from a high-quality linen blend. "
  ...
  Product(
    ...
    category: "Hijab",
    price: 5500,
    description: "Soft and stretchy, this Cotton Candy Jersey Hijab provides maximum comfort and coverage. "
  ...
  Product(
    ...
    category: "Hijab",
    price: 5800,
    description: "Our Luxury Crinkle Chiffon Hijab in Ice Blue offers a lightweight drape with a smooth, flowy texture. "
  ...
  Product(
    ...
    category: "Hijab",
    price: 4200,
    description: "A breathable and lightweight viscose hijab in a soft shell tone. "
  ...
  Product(
    ...
    category: "Dress",
    price: 9290,
    description: "A feminine floral dress featuring pastel petal prints and a flowy A-line silhouette. "
  ...
  Product(
    ...
    category: "Dress",
    price: 7992,
    description: "Inspired by nature, the Floral Daydream Dress blends soft pastels and intricate blooms. "
  ...
  Product(
    ...
    category: "Dress",
    price: 4875,
    description: "Stay effortlessly chic with our Dazed Dress in Sky Blue. "
  ...
  Product(
    ...
    category: "Accessory",
    price: 1900,
    description: "Strong yet gentle, our Gloss Hijab Magnets provide a secure hold without damaging fabric. "
  ...
  Product(
    ...
    category: "Accessory",
    price: 1890,
    description: "A delicate Destiny Chain featuring subtle floral detailing. "
  ...
  Product(
    ...
    category: "Accessory",
    price: 890,
    description: "Soft and comfortable chiffon volumizer designed to create the perfect rounded shape under your hijab. "
